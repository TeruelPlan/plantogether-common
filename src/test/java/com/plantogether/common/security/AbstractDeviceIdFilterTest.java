...
/**
 * Abstract base for DeviceIdFilter regression tests.
 * Each service subclasses this to verify the filter remains wired (R01).
 *
 * Usage:
 * <pre>
 * class DeviceIdFilterTest extends AbstractDeviceIdFilterTest {}
 * </pre>
 */
@ExtendWith(MockitoExtension.class)
public abstract class AbstractDeviceIdFilterTest {
